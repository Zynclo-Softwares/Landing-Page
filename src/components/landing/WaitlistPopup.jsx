                      ...
                      <motion.div key="form" initial={{ opacity: 1 }} exit={{ opacity: 0 }}>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                          <div className="flex gap-2">
                            <div className="flex-1">
                              ...
                              <input
                                ...
                                className="w-full px-3 py-2 rounded-xl border border-white/10 bg-white/5 text-white placeholder-slate-500 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                              />
                            </div>
                            <div className="flex-1">
                              <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1.5 flex items-center gap-1">
                          ...
                          <div>
                            ...
                            {/* iOS public note */}
                            <a
                              href="https://apps.apple.com/us/app/pledgeproof/id6759847480"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-2 px-3 py-2 rounded-xl border border-green-500/40 bg-green-500/10 text-xs text-green-400 font-medium mb-2 hover:bg-green-500/20 transition-colors"
                            >
                              <svg className="w-3.5 h-3.5 shrink-0" viewBox="0 0 814 1000" fill="currentColor"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-57.8-155.5-127.4C46 790.7 0 663 0 541.8c0-207.8 134.4-318 266.5-318 79.5 0 145.6 52.4 195.6 52.4 47.8 0 122.7-56.1 209.8-56.1 33.5 0 121.9 3.2 185.9 85.9zm-124.6-174.4c33.8-40.1 57.9-95.9 57.9-151.7 0-7.7-.6-15.4-1.9-22.4-54.4 1.9-119.4 36.2-158.6 82.8-31.4 37.1-61.2 93-61.2 149.5 0 8.3 1.3 16.6 1.9 19.1 3.2.6 8.4 1.3 13.6 1.3 49 0 109.5-32.7 148.3-78.6z"/></svg>
                              iOS is publicly available on the App Store — tap to download!
                            </a>
                            <div className="flex gap-2">
                              {["Android"].map((p) => (
                                <button
                          ...
                          <p className="text-xs text-slate-500 leading-relaxed border border-white/5 bg-white/[0.03] rounded-xl px-4 py-3">
                             ...
                             <button type="button" onClick={() => setShowWhyImage(true)} className="text-indigo-400 underline underline-offset-2 hover:text-indigo-300 transition-colors">14 days</button>.</span>
                           </p>
